...
public class DeliveryPerson extends Account{
    ...
    public DeliveryPerson(boolean deliveryStatus, double deliveryfee) {
        this.deliveryStatus = deliveryStatus;
        this.deliveryfee = deliveryfee;
        numOfDistru++;
    }
    public DeliveryPerson(String username, String password, String phone_no, String location) {
        super(username, password, location,  phone_no );
    }
